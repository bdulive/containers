...
| `4.3/wolfi/` | Hand-maintained variant on `cgr.dev/chainguard/wolfi-base`. Clears the acl/attr advisories outright and drops the Erlang source build (Wolfi packages `erlang-27` at 27.3.4.17). See its `README.md`. |
...
--download-db-only`) and compare the installed version against the *secdb*:
